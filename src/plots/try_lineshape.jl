...
atmo.σ_Rayl = n2.vmr * σ_out #cross section in cm^2
...
if (RRS)
    ...
    atmo.σ_RRS_JtoJp2 = n2.vmr * σ_out #cross section in cm^2
    ...
    atmo.σ_RRS_JtoJm2 = n2.vmr * σ_out #cross section in cm^2

    # O2
    apply_lineshape!(o2.effCoeff.Δν̃_RoRaman_coeff_JtoJp2, o2.effCoeff.σ_RoRaman_coeff_JtoJp2, collect(grid_out), σ_out, 1, 300.0, 28);
    atmo.σ_RRS_JtoJp2 += o2.vmr * σ_out #cross section in cm^2

    apply_lineshape!(o2.effCoeff.Δν̃_RoRaman_coeff_JtoJm2, o2.effCoeff.σ_RoRaman_coeff_JtoJm2, collect(grid_out), σ_out, 1, 300.0, 40);
    atmo.σ_RRS_JtoJm2 += o2.vmr * σ_out #cross section in cm^2
else if (VS_0to1)
    # N2
    ...
    apply_lineshape!(xin, yin, collect(grid_out), σ_out, 1, 300.0, 40);
    atmo.σ_RVRS_0to1 = n2.vmr * σ_out #cross section in cm^2

    xin = n2.effCoeff.Δν̃_VibRaman_coeff_0to1_hires
    yin = n2.effCoeff.σ_VibRaman_coeff_0to1_hires
    apply_lineshape!(xin, yin, collect(grid_out), σ_out, 1, 300.0, 40);
    atmo.σ_VRS_0to1 = n2.vmr * σ_out #cross section in cm^2
    ...
    apply_lineshape!(xin, yin, collect(grid_out), σ_out, 1, 300.0, 40);
    atmo.σ_RVRS_0to1 += o2.vmr * σ_out #cross section in cm^2

    xin = o2.effCoeff.Δν̃_VibRaman_coeff_0to1_hires
    yin = o2.effCoeff.σ_VibRaman_coeff_0to1_hires
    apply_lineshape!(xin, yin, collect(grid_out), σ_out, 1, 300.0, 40);
    atmo.σ_VRS_0to1 += o2.vmr * σ_out #cross section in cm^2
else if (VS_1to0)
    # N2
    ...
    apply_lineshape!(xin, yin, collect(grid_out), σ_out, 1, 300.0, 40);
    atmo.σ_RVRS_1to0 = n2.vmr * σ_out #cross section in cm^2

    xin = n2.effCoeff.Δν̃_VibRaman_coeff_1to0_hires
    yin = n2.effCoeff.σ_VibRaman_coeff_1to0_hires
    apply_lineshape!(xin, yin, collect(grid_out), σ_out, 1, 300.0, 40);
    atmo.σ_VRS_1to0 = n2.vmr * σ_out #cross section in cm^2
    ...
    apply_lineshape!(xin, yin, collect(grid_out), σ_out, 1, 300.0, 40);
    atmo.σ_RVRS_1to0 += o2.vmr * σ_out #cross section in cm^2
    
    xin = o2.effCoeff.Δν̃_VibRaman_coeff_1to0_hires
    yin = o2.effCoeff.σ_VibRaman_coeff_1to0_hires
    apply_lineshape!(xin, yin, collect(grid_out), σ_out, 1, 300.0, 40);
    atmo.σ_VRS_1to0 += o2.vmr * σ_out #cross section in cm^2
end
plotly()
